...
func (ws *WebStackGenerator) Run(cfg *feeds.Config, writer io.Writer) {
	...
	}).ParseFS(pkg.Templates, "templates/webstack.tmpl"))
...
func defaultSearchEngineURL(cfg *feeds.Config) string {
...
// nolint: funlen
func renderSearchEngines(cfg *feeds.Config) func() string {
	return func() string {
